...
void GCTracer::report_gc_start_impl(GCCause::Cause cause, const Ticks& timestamp) {
  ...
  tracepoint(jvm,report_gc_start,(int)_shared_gc_info.gc_id().id(), (int)_shared_gc_info.name());
}
...
void GCTracer::report_gc_end_impl(const Ticks& timestamp, TimePartitions* time_partitions) {
  ...
  tracepoint(jvm, report_gc_end, (int)_shared_gc_info.gc_id().id(), (int)_shared_gc_info.name(),(int) _shared_gc_info.cause(), (long)_shared_gc_info.sum_of_pauses().value(), (long)_shared_gc_info.longest_pause().value());
}
