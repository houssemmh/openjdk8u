...
LIBS += -llttng-ust -lm -ldl -lpthread
...
Src_Files_EXCLUDE += jsig.c jvmtiEnvRecommended.cpp jvmtiEnvStub.cpp lttng_tp.c
...
LTTNG_DIR=$(GAMMADIR)/src/share/vm/lttng
LTTNG_TP_OBJ: $(LTTNG_TP_SRC)
	gcc -I. -fpic -c $(LTTNG_DIR)/lttng_tp.c
...
$(LIBJVM): $(LIBJVM.o) $(LIBJVM_MAPFILE) $(LD_SCRIPT) $(LTTNG_TP_OBJ)
	$(QUIETLY) {                                                    \
	    echo Linking vm...;                                         \
	    $(LINK_LIB.CXX/PRE_HOOK)                                     \
	    $(LINK_VM) $(LD_SCRIPT_FLAG)                                \
		       $(LFLAGS_VM) -o $@ $(sort $(LIBJVM.o)) $(LTTNG_TP_OBJ) $(LIBS_VM);       \
